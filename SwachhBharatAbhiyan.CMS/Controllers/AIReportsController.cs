...
namespace SwachhBharatAbhiyan.CMS.Controllers
{
    public class AIReportsController : Controller
    {
        ...
        public ActionResult DumpYardWeeklyMonthly()
        {
            ...
            string path = Server.MapPath("~/Images/AI/" + trim_ULB_Name + "/DumpYardWeeklyMonthly.html");
            FileInfo file = new FileInfo(path);
            if (file.Exists)
            {
                file.Delete();
            ...
            //psi.Arguments = $"\"D:/Rohit/ICTSBM_CMS_AI_TEST_NEW/SwachhBharatAbhiyan.CMS/AI_ReportsFiles/EmpWise_Collection.py";
            // string pythonfile = System.Web.Hosting.HostingEnvironment.MapPath("~/AI_ReportsFiles/EmpWise_Collection.py");
            string pythonfile = System.Web.Hosting.HostingEnvironment.MapPath("~/AI_ReportsFiles/DumpYardForeCast/DumpYardWeekAndMonthwiseReport.py");
