# Run python forecast_deply_1.py --server 202.65.157.253 --database LIVEAdvanceAheriGhantaGadi --ulbname AheriNagarPanchayat --hostname localhost --filename DumpYardForecast -ReportTitle AheriNagarPanchayat
import pymssql
import pandas as pd
import argparse
import os
